...
struct Data
{
	...
	std::vector<std::pair<sf::Vector2u, std::pair<int, wall_gen::wall_dir_no>>> wall_cordinates_sing; //like 1 2,3 2,3 4,4 3,2 3,1 2,8 7
	std::vector<std::vector<sf::Vector2u>> wall_cordinates_mult;

	std::vector<sf::Vector2u> marker_pos_sing;
	std::vector<std::vector<sf::Vector2u>> marker_pos_mult;
	...
	std::vector<sf::Vector3i> spring_arg; //like 1 2,3 4,2 3
